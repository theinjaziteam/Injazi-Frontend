...
export default function LoginView() {
    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'register') {
                // REGISTER FLOW — backend sends verification email server-side
    ...
    const handleResendCode = async () => {
        ...
        setIsLoading(true);
        try {
            // Backend sends new code via email server-side
    ...
    const handleForgotPassword = async () => {
        ...
        setIsLoading(true);
        try {
            // Backend sends reset code via email server-side
                            ...
                            {showLegal === 'terms' ? (
                                ...
                                <div className="space-y-6">
                                    ...
                                    <section>
                                        ...
                                        <p className="text-gray-600 mb-2"><strong>Personal Info:</strong> Name, email, country, goals, preferences, task submissions, uploaded files (images, documents, audio).</p>
                                    ...
                                    <section>
                                        ...
                                        <p className="text-gray-600">We use AI powered by Groq (LLaMA). Your goals and tasks are processed for personalized recommendations. AI interactions are processed in real-time and not stored beyond your active session unless explicitly saved.</p>
                                    </section>
                                    
                                    <section>
                                        <h3 className="font-bold text-base mb-2">5. Information Sharing</h3>
                                        <p className="text-gray-600 mb-2">We share with: cloud providers, email services, payment processors, analytics providers, AI services (Groq).</p>
