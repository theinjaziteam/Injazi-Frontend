...
export default function DashboardView() {
    ...
    return (
        <div className="h-full overflow-y-auto pb-safe scroll-smooth">
            <div className="min-h-full pb-28 animate-fade-in theme-transition theme-bg-page">
                {/* Header - Brand colors */}
                <div className="theme-brand-primary text-white px-6 pt-safe pt-12 pb-16 rounded-b-[3rem] relative overflow-hidden shadow-2xl">
                    <div className="flex justify-between items-center relative z-20 mb-6 mt-4">
                        ...
                        <div className="flex gap-2">
                            <button 
                                ...
                                className="p-2 bg-[#DFF3E4] text-[#171738] rounded-full hover:bg-white transition-colors shadow-lg"
                            >
                ...
                <div className="px-6 -mt-8 relative z-20 space-y-6">
                    ...
                    <Card className="p-0 overflow-hidden border theme-border-card theme-shadow-card">
                                ...
                                <div className="space-y-3 mb-6">
                                   {pendingDailyTasks.map(task => (
                                       <div 
                                           ...
                                           className="p-4 rounded-xl flex justify-between items-center cursor-pointer transition-all group theme-item-bg border theme-border hover:theme-bg-hover theme-shadow-sm"
                                       >
                                           <div>
                    ...
                    <div className="rounded-[2rem] border theme-border-card theme-shadow-card overflow-hidden transition-all duration-300 theme-bg-card">
                        <div 
                                    ...
                                    <div className="space-y-3">
                                        {adgemOffers.map(offer => (
                                            <div 
                                                ...
                                                className="p-4 rounded-2xl flex items-center gap-4 cursor-pointer transition-all group theme-item-bg border theme-border hover:theme-bg-hover theme-shadow-sm"
                                            >
                                                {/* App Icon */}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-6 animate-fade-in">
                        <div className="theme-bg-card rounded-[2rem] w-full max-w-md p-8 theme-shadow-xl animate-scale-in">
                            ...
                            <textarea 
                                ...
                                className="w-full h-32 p-4 theme-bg-input rounded-xl border theme-border mb-6 focus:outline-none focus:border-secondary theme-text-primary" 
                            ...
                            <button 
                                ...
                                className="w-full mt-4 text-xs font-bold theme-text-muted uppercase tracking-widest hover:theme-text-secondary transition-colors"
                            >
                                Cancel
                            </button>
                        </div>
